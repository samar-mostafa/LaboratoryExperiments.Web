...
namespace LaboratoryExperiments.Web.Data.Migrations
{
    ...
    [Migration("20240219103541_AddTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaboratoryExperiments.Web.Data.DomainModels.EffleuntExperiment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LaboratoryExperiments.Web.Data.DomainModels.InffleuntExperiment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InffleuntExperiments");
                });
            ...
            modelBuilder.Entity("LaboratoryExperiments.Web.Data.DomainModels.Test", b =>
                {
                    ...
                    b.Property<int>("EffleuntExperimentId")
                        .HasColumnType("int");

                    b.Property<float>("EnteredValue")
                        .HasColumnType("real");

                    b.Property<int>("InffleuntExperimentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EffleuntExperimentId");

                    b.HasIndex("InffleuntExperimentId");
            ...
            modelBuilder.Entity("LaboratoryExperiments.Web.Data.DomainModels.Test", b =>
                {
                    b.HasOne("LaboratoryExperiments.Web.Data.DomainModels.EffleuntExperiment", "EffleuntExperiment")
                        .WithMany()
                        .HasForeignKey("EffleuntExperimentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LaboratoryExperiments.Web.Data.DomainModels.InffleuntExperiment", "InffleuntExperiment")
                        .WithMany()
                        .HasForeignKey("InffleuntExperimentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("EffleuntExperiment");

                    b.Navigation("InffleuntExperiment");
